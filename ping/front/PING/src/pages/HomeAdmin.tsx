        ...
        <div className="w-screen min-h-screen bg-gradient-to-b from-[#E1A624] to-[#D4D3DC] flex flex-col relative">
            ...
            <div className="absolute top-6 right-6">
                <Link to="/profile/admin">
                    <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-[#F89BEB] to-[#EA508E] text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200">
