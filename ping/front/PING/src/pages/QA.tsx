...
const QA = () => {
  ...
  // Load FAQs on component mount and listen for changes
  useEffect(() => {
    const loadFaqs = () => {
      try {
  ...
  return (
      <div className="w-screen h-screen bg-[#384454] flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center pt-8 px-4">
          ...
          {/*        <p className="text-gray-300 text-lg">Aucune question trouvée pour "{searchQuery}"</p>*/}
          {/*      </div>*/}
          {/*  ) : (*/}
          {/*      filteredFaqs.map((faq, idx) => (*/}
          {/*          <div key={idx} className="border-b border-gray-600">*/}
          {/*            <button*/}
          {/*                type="button"*/}
          {/*                onClick={() => toggle(idx)}*/}
          {/*                className="w-full text-left px-6 py-6 font-semibold flex justify-between items-center text-white hover:bg-gray-600/20 transition-colors duration-200"*/}
          ...
          {/* Footer */}
          <div className="text-center mt-12 mb-8 text-sm text-gray-300">
